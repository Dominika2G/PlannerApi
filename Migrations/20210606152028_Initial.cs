...
namespace PlannerApi.Migrations
{
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Sprints",
                columns: new[] { "SprintId", "EndDate", "Name", "StartDate" },
                values: new object[,]
                {
                    { 2, new DateTime(2021, 3, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Sprint 2", new DateTime(2021, 2, 16, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 3, new DateTime(2021, 2, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), "Sprint 3", new DateTime(2021, 1, 31, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 1, new DateTime(2021, 3, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), "Sprint 1", new DateTime(2021, 3, 2, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 5, new DateTime(2021, 1, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), "Sprint 5", new DateTime(2021, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 4, new DateTime(2021, 1, 30, 0, 0, 0, 0, DateTimeKind.Unspecified), "Sprint 4", new DateTime(2021, 1, 16, 0, 0, 0, 0, DateTimeKind.Unspecified) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "220c495c-95f9-411d-aa86-6b96c2778765", "Task 1 description", "10", "Task 1", "547fb67e-7bac-4e68-ae07-7d7a2309b9d9", 1, 1, 1, 2 },
                    { 2, "877a0a41-23b3-4511-89f5-13d1cd5b750a", "Task 2 description", "16", "Task 2", "547fb67e-7bac-4e68-ae07-7d7a2309b9d9", 2, 2, 3, 2 }
                });
